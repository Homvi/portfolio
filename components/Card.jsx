...
const Card = () => {
    return (
        <div className="rounded-xl  m-5 mr-0 ml-5 shadow-xl hover:shadow-cyan-500/40 shadow-cyan-500/30 hover:scale-[1.01] transition-all duration-75 w-60 h-80 mx-auto md:mx-3  mt-5 bg-gradient-to-r p-1 from-[#6EE7B7] via-[#3B82F6] to-[#9333EA]">
            <div className="flex flex-col justify-between h-full bg-black text-white rounded-lg p-4">
                ...
                <div className="flex justify-start py-2">
                    <span className='w-5 mr-5 text-3xl'>
                        <Link href="#git">
                            <AiFillGithub />
                        </Link>
                    </span>
                    <span className='w-5 text-3xl '>
                        <Link href="#git">
                            <MdWebAsset />
                        </Link>
                    </span>
